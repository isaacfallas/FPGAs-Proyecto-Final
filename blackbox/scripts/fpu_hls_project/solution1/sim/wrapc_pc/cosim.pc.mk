...
$(ObjDir)/dummy_tb.cpp_pre.cpp.tb.o : dummy_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling dummy_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/fpu_stub.cpp_pre.cpp.tb.o : fpu_stub.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling fpu_stub.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c -std=c++11 $(IFLAG) $(DFLAG) $< -o $@; \
