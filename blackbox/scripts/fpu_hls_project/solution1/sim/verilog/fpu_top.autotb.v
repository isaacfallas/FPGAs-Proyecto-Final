...
`define AUTOTB_DUT      fpu_top
`define AUTOTB_DUT_INST AESL_inst_fpu_top
`define AUTOTB_TOP      apatb_fpu_top_top
`define AUTOTB_LAT_RESULT_FILE "fpu_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fpu_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fpu_top_top
...
`define AESL_DEPTH_rst_n 1
`define AESL_DEPTH_ce_r 1
`define AESL_DEPTH_valid_in 1
`define AESL_DEPTH_precision 1
`define AESL_DEPTH_op 1
`define AESL_DEPTH_operand_a 1
`define AESL_DEPTH_operand_b 1
`define AESL_DEPTH_valid_out 1
`define AESL_DEPTH_precision_out 1
`define AESL_DEPTH_result 1
`define AESL_DEPTH_exceptions 1
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 0;
parameter LENGTH_ce_r = 1;
parameter LENGTH_clk = 1;
parameter LENGTH_exceptions = 1;
parameter LENGTH_op = 1;
parameter LENGTH_operand_a = 1;
parameter LENGTH_operand_b = 1;
parameter LENGTH_precision = 1;
parameter LENGTH_precision_out = 1;
parameter LENGTH_result = 1;
parameter LENGTH_rst_n = 1;
parameter LENGTH_valid_in = 1;
parameter LENGTH_valid_out = 1;
