...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fpu_top.autotvin.dat"
	set constFileTvOut       "fpu_top.autotvout.dat"
	set constFileHdlTvIn     "fpu_top.autohdltvin.dat"
	set constFileHdlTvOut    "fpu_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
